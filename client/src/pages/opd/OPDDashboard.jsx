...
import { Users, IndianRupee, Banknote, Smartphone, UserPlus, TrendingUp, CalendarClock, Bell, Loader2, Info, Calendar, Clock } from "lucide-react";
...
export default function OPDDashboard() {
  ...
  // Keep the footer clock live (updates every minute)
  useEffect(() => {
    ...
    <div className="relative p-3 sm:p-6 max-w-7xl mx-auto w-full overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          {/* Today's Follow-Ups */}
          <div className="bg-amber-45/90 dark:bg-amber-500/5 border border-amber-200 dark:border-amber-500/20 rounded-2xl p-4 sm:p-5 backdrop-blur-sm">
          ...
          {/* Incoming Patients */}
          <div className="bg-blue-45/90 dark:bg-blue-500/5 border border-blue-200 dark:border-blue-500/20 rounded-2xl p-4 sm:p-5 backdrop-blur-sm">
            <div className="flex items-center justify-between mb-3">
          ...
          {/* Pending Reminders */}
          <div className="bg-violet-45/90 dark:bg-violet-500/5 border border-violet-200 dark:border-violet-500/20 rounded-2xl p-4 sm:p-5 backdrop-blur-sm">
            <div className="flex items-center justify-between mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          {/* Payment split */}
          <div className="bg-white/10 dark:bg-slate-900/10 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm dark:shadow-none transition-colors duration-300 backdrop-blur-sm">
          ...
          {/* Upcoming Follow-Ups */}
          <div className="bg-white/10 dark:bg-slate-900/10 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm dark:shadow-none transition-colors duration-300 md:col-span-2 lg:col-span-1 backdrop-blur-sm">
            <h3 className="text-slate-800 dark:text-white font-semibold text-sm mb-4 flex items-center gap-2">
        ...
        {/* Recent patients */}
        <div className="bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm dark:shadow-none transition-colors duration-300 backdrop-blur-sm mb-6">
        ...
        {/* Footer info bar */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-2xl px-5 py-3.5 backdrop-blur-sm">
          <div className="flex items-center gap-2.5 text-slate-500 dark:text-slate-400 text-sm">
            <span className="w-6 h-6 rounded-full bg-teal-600 text-white flex items-center justify-center flex-shrink-0">
              <Info className="w-3.5 h-3.5" />
            </span>
            Keep track of OPD activities, follow-ups, and collections in one place.
          </div>
          <div className="flex items-center gap-4 text-slate-500 dark:text-slate-400 text-sm flex-shrink-0">
